...
{{user1}}: Please recommend me a coin to invest in.
Result: [RESPOND]

{{user1}}: Please recommend position of Dogecoin.
Result: [RESPOND]

{{user1}}: Is bitcoin long or short?
Result: [RESPOND]
...
if message is related to crypto analysis like market, coin, news, etc, you should use the CRYPTO_ANALYSIS action.
` + messageCompletionFooter;
